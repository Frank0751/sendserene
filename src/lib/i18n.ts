...
const fr: Dictionary = {
  ...
  "nav.evidence": "Dossier de preuves",
...
const es: Dictionary = {
  ...
  "nav.decoder": "Descodificador",
  "nav.evidence": "Expediente de pruebas",
...
const tg: Dictionary = {
  ...
  "nav.evidence": "Pakete ng ebidensya",
